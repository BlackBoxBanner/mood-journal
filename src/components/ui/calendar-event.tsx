  ...
  return new Array(7).fill(0).map((_, i) => {
    ...
    return (
      <ContextMenu key={`${currentDate}-${i}-${Math.random()}`}>
        <ContextMenuTrigger ref={contextMenuTriggerRef} asChild>
          <button
            className={cn(
            ...
            onClick={() => {
              ...
              isSameDay(currentDate, selectedDate) ? contextMenuTriggerRef.current.click() : null
            }}
                  ...
                  {dayEvents.length === 0 && (
                    <>
                      <Link
                        ...
                        prefetch={false}
                      >
                        <DropdownMenuItem key={`ContextMenuItem-${currentDate}-create`}>
                          Create
                        </DropdownMenuItem>
                      </Link>
                    </>
